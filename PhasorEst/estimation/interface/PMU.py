...
class Receiver:
    ...
    def receive(self, timeout=1):
        ...
        try:
            ...
            # xml, __address = self.socketIn.recvfrom(8192) # existing code
        except socket.timeout:
            return
        if self.forward:
            print("forwarded data is ",xml)
        ...
        try:
            ...
            # print(" The self.xmlInfo from Phasor Estimator is  here girl", self.xmlInfo)
